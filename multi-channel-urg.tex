...
\begin{equation}\begin{aligned}
	Z(h)^\prime &= -\beta\sum_{M}\left[\sum_{m=-M+1}^{M-1}\frac{\left(e^{-\beta \lambda_{m, +}^{M,h}} - e^{-\beta \lambda_{m, -}^{M,h}}\right)\left(\epsilon^h_m + J/2\right)}{\sqrt{2J^2 + 4\epsilon^h_m\left(\epsilon^h_m + J\right) }} + \frac{1}{2}\left(e^{-\beta \epsilon^h_{M}} - e^{\beta \epsilon^h_{- M}}\right)\right] \\
		    &= \beta\sum_{M}\left[\sum_{m=-M+1}^{M-1}2e^{\beta J/2}\frac{\alpha\sinh \sqrt{J^2 + 4\alpha^2} }{\sqrt{J^2 + 4\alpha^2}} + e^{-\beta JM/2}\sinh \left(\beta h/2\right)\right] \\
\end{aligned}\end{equation}
