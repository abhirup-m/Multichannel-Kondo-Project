...
\begin{equation}\begin{aligned}
	...
	\lim_{h \to 0}\frac{\:\mathrm{d}^2Z(h)}{\:\mathrm{d}h^2} &= \beta\sum_{M=M_\text{min}}^{M_\text{max}}\left[\frac{1}{2}\sum_{m=-M, \atop{m\in \mathbb{Z}}}^{M-1}\frac{e^{\beta J/4}}{\frac{J}{2}\sqrt{1 + (m+1/2)^2}}\left(\sinh \beta\frac{J}{2}\sqrt{1 + (m+1/2)^2} + \beta \frac{J}{2}(m+1/2)^2 \frac{\cosh\beta\frac{J}{2}\sqrt{1 + (m+1/2)^2}}{\sqrt{1 + (m+1/2)^2}} \right.\right.\\
...
The low temperature behaviour is \(\chi(T\to 0) \sim 1/T\).
