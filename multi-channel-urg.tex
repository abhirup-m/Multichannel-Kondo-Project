...
\begin{equation}\begin{aligned}
	H_\text{eff}^{\frac{1}{2}, s_\text{tot}, s^z_\text{tot}} = H_0 + \frac{J}{2}s^z_\text{tot} + \frac{J^2}{4}\left( \frac{1}{2} + S_d^z \right) \gamma_{s_\text{tot}}^{s_\text{tot}^z}\chi_{s_\text{tot}}^{s_\text{tot}^z}\left[1 + {\gamma_{s_\text{tot}}^{s_\text{tot}^z}} H_0 - \frac{\gamma_{s_\text{tot}}^{s_\text{tot}^z}}{\chi_{s_\text{tot}}^{s_\text{tot}^z}} s^-_\text{tot}X^\dagger_{1,\text{tot}} + {\gamma_{s_\text{tot}}^{s_\text{tot}^z}}^2 H_0^2 - {\gamma_{s_\text{tot}}^{s_\text{tot}^z}}^3 Z_{1,\text{tot}} H_0\right] \\
+ \frac{J^2}{4}\left( \frac{1}{2} - S_d^z \right)\gamma_{s_\text{tot}}^{-s_\text{tot}^z}\chi_{s_\text{tot}}^{-s_\text{tot}^z}\left[1 + {\gamma_{s_\text{tot}}^{-s_\text{tot}^z}} H_0 + \frac{\gamma_{s_\text{tot}}^{-s_\text{tot}^z}}{\chi_{s_\text{tot}}^{-s_\text{tot}^z}} s^+_\text{tot}X_{1,\text{tot}} + {\gamma_{s_\text{tot}}^{-s_\text{tot}^z}}^2 H_0^2 - {\gamma_{s_\text{tot}}^{-s_\text{tot}^z}}^3 Z_{1,\text{tot}} H_0\right]
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	H_\text{eff}^{\pm\frac{1}{2}, 0, 0} &= H_0\\
	H_\text{eff}^{\pm\frac{1}{2}, 1, \pm 1} &= H_0 + \frac{J}{2}\\
	H_\text{eff}^{-\frac{1}{2}, 1, 1} &= H_0 + \frac{J}{2} + \frac{J^2}{4}\frac{2}{E_\text{gs}}\left[1 + \frac{H_0}{E_\text{gs}} + \frac{s^+_\text{tot}X_{1,\text{tot}}}{2 E_\text{gs}} + \frac{H_0^2 }{E_\text{gs}^2} - \frac{Z_{1,\text{tot}} H_0}{E_\text{gs}^3}\right] \\
	H_\text{eff}^{\frac{1}{2}, 1, -1} &= H_0 - \frac{J}{2} + \frac{J^2}{4}\frac{2}{E_\text{gs}}\left[1 + \frac{H_0}{E_\text{gs}}  - \frac{s^-_\text{tot}X^\dagger_{1,\text{tot}}}{2 E_\text{gs}}  + \frac{H_0^2}{E_\text{gs}^2}  - \frac{ Z_{1,\text{tot}} H_0}{E_\text{gs}^3}\right] \\
	H_\text{eff}^{-\frac{1}{2}, 1, 0} &= H_0 + \frac{J^2}{4}\frac{2}{E_\text{gs} + J/2}\left[1 + \frac{ H_0}{E_\text{gs} + J/2} + \frac{ s^+_\text{tot}X_{1,\text{tot}}}{2 E_\text{gs} + J} + \frac{H_0^2}{\left(E_\text{gs} + J/2\right)^2} - \frac{Z_{1,\text{tot}} H_0}{\left(E_\text{gs} + J/2\right)^3} \right] \\
	H_\text{eff}^{\frac{1}{2}, 1, 0} &= H_0 + \frac{J^2}{4}\frac{2}{E_\text{gs} + J/2}\left[1 + \frac{ H_0}{E_\text{gs} + J/2} - \frac{ s^-_\text{tot}X^\dagger_{1,\text{tot}}}{2 E_\text{gs} + J} + \frac{H_0^2}{\left(E_\text{gs} + J/2\right)^2} - \frac{Z_{1,\text{tot}} H_0}{\left(E_\text{gs} + J/2\right)^3} \right] \\
\end{aligned}\end{equation}
