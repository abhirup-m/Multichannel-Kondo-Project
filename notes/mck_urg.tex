...
\begin{equation}\begin{aligned}
	\mathbb{S}_d^z \ket{m_d^z} = m_d^z \ket{m_d^z}, &&\mathbb{S}_d^\pm \ket{m_d^z} \sim \ket{m_d^z \pm 1}
\end{aligned}\end{equation}
