...
\end{aligned}\end{equation}
Following \cite{anirbanmott1}, one can follow the RG evolution of the dual coupling \(J^\prime = \frac{4t^2}{J}\), leading to a \(k-\)space-averaged self-energy for each channel (eq. 33 of \cite{anirbanmott1})
\begin{equation}\begin{aligned}
