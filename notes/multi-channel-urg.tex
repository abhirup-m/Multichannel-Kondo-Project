...
\section{URG equations for the multi-channel spin-\(S\) Kondo model}
...
The next order renormalization is of the form
\begin{equation}\begin{aligned}
	\Delta H^{(3)}_j = \underbrace{c^\dagger T \frac{1}{\omega^\prime - H_D} H_X \frac{1}{\omega^\prime - H_D} T^\dagger c}_\text{first term (particle sector)} ~+~ \underbrace{T^\dagger c \frac{1}{\omega - H_D} H_X \frac{1}{\omega - H_D} c^\dagger T}_\text{second term (hole sector)}
\end{aligned}\end{equation}

Before we start, we will make another simplification. A general term of \(\Delta H\) will be of the form
\begin{equation}\begin{aligned}
...
The various terms in each sector can be represented as \(a|b|c\), where \(a,b,c \in \left\{z,+,-\right\} \) and represent the operator for the conduction electrons in the three stages. We will only calculate the terms in the particle sector, the ones in hole sector will be equal to these because of particle-hole symmetry.
\paragraph{\(z|z|z\)}
\begin{equation}\begin{aligned}
...
\begin{align}
	\lambda_{m, \pm}^{M, h} &= -\frac{J}{4} + (2m+1)h/2 \pm \frac{1}{2}\sqrt{J^2x^M_m + \left[(2m+1)h - \frac{J}{2}\right]^2 - 4m(m+1)(h^2 - J^2/4)} \\
				&= -\frac{J}{4} + (2m+1)h/2 \pm \frac{1}{2}\sqrt{J^2(M + \frac{1}{2})^2 + h^2 - (2m+1)Jh}	= -\frac{J}{4} + (2m+1)h/2 \pm \phi^M_m
\end{align}
