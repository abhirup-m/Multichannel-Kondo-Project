...
The thermal entropy at temperature \(T\) is given by
\begin{equation}\begin{aligned}
	S(T) = -k_B \sum_{n}P_n \ln P_n
\end{aligned}\end{equation}
where \(n\) sums over all eigenstates of the system. The state \(n\) is understood to have an energy \(E_n\). \(P_n\) is the probability to find the system in the state \(n\) from a canonical ensemble at temperature \(T\). This probability is given by
\begin{equation}\begin{aligned}
	P_n = \frac{e^{-\beta E_n}}{Z}
\end{aligned}\end{equation}
where \(Z = \sum_n d_n e^{-\beta E_n}\) and \(d_n\) is the degeneracy of the state \(E_n\). Substituting this gives for the entropy:
\begin{equation}\begin{aligned}
	S(T) = -k_B \sum_{n}\frac{e^{-\beta E_n}}{Z} \ln \frac{e^{-\beta E_n}}{Z}
\end{aligned}\end{equation}
Taking the limit of \(\beta \to \infty\) gives \(Z \to d_\text{gs}e^{-\beta E_\text{gs}}\):
\begin{equation}\begin{aligned}
	S(T) = -k_B \frac{d_\text{gs} e^{-\beta E_\text{gs}}}{d_\text{gs}e^{-\beta E_\text{gs}}} \ln \frac{e^{-\beta E_\text{gs}}}{d_\text{gs}e^{-\beta E_\text{gs}}} = k_B \ln d_\text{gs}
\end{aligned}\end{equation}
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.6\textwidth]{../numerics/entropy_comparison.pdf}
