...
% as we add the excitations on top of the zero-bandwidth model by tuning the real space nearest-neighbor hopping strength reinforces the presence of orthogonality catastrophe. 
We extend our results to underscreened and perfectly screened MCK models through duality arguments.
%a Strong and weak coupling duality also sheds light on the presence of an intermediate coupling fixed point in the MCK problem. 
...
%of studying the zero-bandwidth model followed by the systematic addition of excitations, which can be used to study other impurity problems.
