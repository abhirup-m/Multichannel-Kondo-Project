...
\noindent For a $K$ channel star graph model we compute various entanglement measures in each of the $K$ degenerate ground states labeled by the $J^z$ eigenvalues as $|J^z\rangle$.
