...
{\color{blue}There exist other renormalisation group schemes that depend on canonical transformations, such as Wegner's continuous unitary transformations (CUT) RG (PUT IN REFERENCE) and the similarity RG method by Glaszek and Wilson (PUT IN REFERENCE). There are at least two specific distinctions between the CUT RG and the URG method adopted in the present work.
\begin{itemize}
