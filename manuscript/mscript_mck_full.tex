...
\begin{equation}\begin{aligned}
	m(h=0^\pm) = \theta(h)\bra{J^z=\frac{K-1}{2}} S_d^z \ket{J^z=\frac{K-1}{2}} + \theta(-h)\bra{J^z=-\frac{K-1}{2}}S_d^z\ket{J^z=-\frac{K-1}{2}} = \pm  \frac{1}{2} \frac{1-K}{1 + K}
\end{aligned}\end{equation}
...
\end{aligned}\end{equation}
In later parts of the work, we will show that this phase shift are linked to the critical non-Fermi liquid exponents of thermodynamic quantities at the fixed point.
