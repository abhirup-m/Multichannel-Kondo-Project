...
The full list of energy eigenvalues at a particular value of \(M\) (characterised by the total spin operator \(J^z = S_d^z + s_\text{tot}^z\)) is
\begin{equation}\begin{aligned}
\label{stargraph_spectrum}
&		JM/2 - h/2, &&\ket{J=M+\frac{1}{2},J^z=-M-\frac{1}{2},s_\text{tot}=M}, && m = -M\\
&-J/4 \pm \sqrt{J^2x^M_m/4 + \alpha^2}, &&\ket{J=M-\frac{1}{2},J^z=m+\frac{1}{2},s_\text{tot}=M}, &&m=-M,\ldots,M-1\\
&JM/2 + h/2, &&\ket{J=M+\frac{1}{2},J^z=M+\frac{1}{2},s_\text{tot}=M},&& m = M\\
\end{aligned}\end{equation}
The eigenstates for each value of \(M,m\) in the \(J=M-\frac{1}{2}\) sector are given by
\begin{equation}\begin{aligned}
	\ket{M-\frac{1}{2},m+\frac{1}{2},M} =\mathcal{C}_\pm \ket{\uparrow, M, m} \pm \sqrt{1 - \mathcal{C}_\pm^2} \ket{\downarrow, M, m+1}, ~ ~ \mathcal{C}_\pm = \frac{J\sqrt{x_m^M}/2}{\sqrt{J^2 x_m^M/4 + \left(\alpha \mp \sqrt{\alpha^2 + J^2 x_m^M/4}\right)^2 }}
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	\ket{J=\frac{K-1}{2},J^z= \frac{\sigma}{2}\left(K-1\right),s_\text{tot}=\frac{K}{2}} = \frac{1}{\sqrt{1 + K}} \ket{\sigma}_d\otimes\ket{s_\text{tot}^z=\sigma(\frac{K}{2}-1)} - \frac{\sqrt K}{\sqrt{1 + K}}\ket{\bar\sigma}_d\otimes\ket{s_\text{tot}^z=\sigma\frac{K}{2}},
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	\hspace*{-15pt}\ket{J^z= \frac{\sigma}{2}\left(K-1\right)} = \frac{1}{\sqrt{K(1 + K)}} \left[\ket{\sigma}_d\otimes\left(\ket{\bar\sigma,\sigma,\ldots,\sigma} + \ket{\sigma,\bar\sigma,\ldots,\sigma} + \ldots + \ket{\sigma,\sigma\ldots,\bar\sigma}\right) - K\ket{\bar\sigma}_d\otimes \ket{\sigma,\sigma,\ldots,\sigma}\right].\label{polarised-state}
\end{aligned}\end{equation}
...
\begin{equation}\begin{aligned}
	\ket{J^z= \frac{\sigma}{2}\left(K-1\right)} = \frac{1}{\sqrt{K(1 + K)}} \sum_{l=1}^K\ket{\sigma}_d\otimes\left[\ket{\bar\sigma}_l - \ket{\sigma}_l\right] \otimes\ket{\sigma,\ldots,\sigma}_{l^\prime} = \frac{\sqrt 2}{\sqrt{K(1 + K)}} \sum_{l=1}^K \ket{\text{SS}_{d,l}}\otimes\ket{\sigma,\ldots,\sigma}_{l^\prime}.\label{singlet-chain}
\end{aligned}\end{equation}
